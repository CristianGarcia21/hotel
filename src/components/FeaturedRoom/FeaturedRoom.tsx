      ...
      <div className=" md:py-10 md:w-1/2 text-left">
        ...
        <div className=" flex flex-col md:flex-row md:items-end justify-between mt-5">
          <div className="flex mb-3 md:mb-0">
            <div className="flex gap-3 flex-col items-center justify-between mr-4">
              <p className=" text-sm lg:text-xl text-center">Start From</p>
              <p className=" md:font-bold flex font-medium text-lg xl:text-5xl">
                ${featuredRoom.price}
              </p>
            </div>
            <div className="flex gap-3 flex-col items-center justify-between mr-4">
              <p className=" text-sm lg:text-xl text-center">Discount</p>
              <p className=" md:font-bold flex font-medium text-lg xl:text-5xl">
